...
@variables X E M T
eqs = [
    X ~ 0.65X + 0.3E + 0.3M + 0.2T,
    E ~ 0.1X + 0.1E + 0.15M + 0.1T,
    M ~ 0.25X + 0.35E + 0.15M + 0.3T,
    T ~ 0X + 0.25E + 0.4M + 0.4T
]
#  -0.3E - 0.3M - 0.2T + 0.35X ~ 0
# 0.9E - 0.15M - 0.1T - 0.1X ~ 0
# -0.35E + 0.85M - 0.3T - 0.25X ~ 0
# -0.25E - 0.4M + 0.6T ~ 0
f2(x) = x.lhs - x.rhs
100 .* f2.(eqs)
# X E M T
...
rref(A)
@variables x6
[100, 0 ,50, -70, 80,0] + x6 * [1,1,1,1,1, 1]